 ...
 * <a
 * href="http://www.jpeg.org/public/jfif.pdf">http://www.jpeg.org/public/jfif.
 * pdf</a>
 * <p>
...
public class JFIFInputStream extends FilterInputStream {
	...
	public final static int SOF0_MARKER = 0xffc0;// nondifferential
													// Huffman-coding frames
													// with baseline DCT.
	public final static int SOF1_MARKER = 0xffc1;// nondifferential
													// Huffman-coding frames
													// with extended sequential
													// DCT.
	public final static int SOF2_MARKER = 0xffc2;// nondifferential
													// Huffman-coding frames
													// with progressive DCT.
	public final static int SOF3_MARKER = 0xffc3;// nondifferential
													// Huffman-coding frames
													// with lossless
													// (sequential) data.

	// public final static int SOF4_MARKER = 0xffc4;//
	public final static int SOF5_MARKER = 0xffc5;// differential Huffman-coding
													// frames with differential
													// sequential DCT.
	public final static int SOF6_MARKER = 0xffc6;// differential Huffman-coding
													// frames with differential
													// progressive DCT.
	public final static int SOF7_MARKER = 0xffc7;// differential Huffman-coding
													// frames with differential
													// lossless data.

	// public final static int SOF8_MARKER = 0xffc8;//
	public final static int SOF9_MARKER = 0xffc9;// nondifferential
													// Arithmetic-coding frames
													// with extended sequential
													// DCT.
	public final static int SOFA_MARKER = 0xffcA;// nondifferential
													// Arithmetic-coding frames
													// with progressive DCT.
	public final static int SOFB_MARKER = 0xffcB;// nondifferential
													// Arithmetic-coding frames
													// with lossless
													// (sequential) data.
	// public final static int SOFC_MARKER = 0xffcC;//
	public final static int SOFD_MARKER = 0xffcD;// differential
													// Arithmetic-coding frames
													// with differential
													// sequential DCT.
	public final static int SOFE_MARKER = 0xffcE;// differential
													// Arithmetic-coding frames
													// with differential
													// progressive DCT.
	public final static int SOFF_MARKER = 0xffcF;// differential
													// Arithmetic-coding frames
													// with differential
													// lossless DCT.
	...
	public JFIFInputStream(InputStream in) {
		...
		standaloneMarkers.add(TEM_MARKER); // TEM_MARKER Temporary private use
	...
	public Segment getNextSegment() throws IOException {
		...
		markerFound = false;
		/*
		 * if (marker <= 0xff00 || marker >= 0xffff) { throw new
		 * IOException("JFIFInputStream found illegal marker " +
		 * Integer.toHexString(marker) + " at offset " + offset +
	 ...
	 * 
	 * @param readlimit
	 *            the maximum limit of b that can be read before the mark
