...
public class ByteArrayImageInputStream extends ImageInputStreamImpl {
	 ...
	 * <code>buf[streamPos]</code> is the next byte to be read.
	 */
	protected byte buf[];
	 ...
	 * this input stream. If <code>streamPos</code> equals <code>count</code>,
	 * then <code>-1</code> is returned to indicate end of file. Otherwise, the
	 * number <code>k</code> of bytes read is equal to the smaller of
	 * <code>len</code> and <code>count-streamPos</code>. If <code>k</code> is
	 * positive, then bytes <code>buf[streamPos]</code> through
	 * <code>buf[streamPos+k-1]</code> are copied into <code>b[off]</code>
	 * through <code>b[off+k-1]</code> in the manner performed by
	 * <code>System.arraycopy</code>. The value <code>k</code> is added into
	 * <code>streamPos</code> and <code>k</code> is returned.
	 * <p>
	 * This <code>read</code> method cannot block.
	 * 
	 * @param b
	 ...
	 * <code>n</code> and <code>count-streamPos</code>. The value <code>k</code>
	 * is added into <code>streamPos</code> and <code>k</code> is returned.
	 * 
	 * @param n
	 ...
	 * <p>
	 * The value returned is <code>count&nbsp;- streamPos</code>, which is the
